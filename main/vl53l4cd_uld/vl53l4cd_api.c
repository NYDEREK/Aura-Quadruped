...
static const uint8_t VL53L4CD_DEFAULT_CONFIGURATION[] = {
	...
	#endif
	0x01, /* 0x2e : I2C pull-ups are at the board's 3.3 V AVDD rail, not 1.8 V. */
	0x01, /* 0x2f : GPIO1 uses the board's 3.3 V AVDD I/O domain. */
		...
		VL53L4CD_ResultsData_t *p_result)
{
	...
	/* A malformed or not-yet-ready sample can report zero SPADs. Keep the
	 * application alive and mark the derived rates as unavailable. */
